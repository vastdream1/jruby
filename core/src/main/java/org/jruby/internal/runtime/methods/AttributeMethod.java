 ...
 */
public abstract class AttributeMethod extends JavaMethod.JavaMethodZeroOrOneOrTwo {
    private MethodData methodData;
    private final String variableName;
    private VariableAccessor accessor = VariableAccessor.DUMMY_ACCESSOR;

    public AttributeMethod(RubyModule implementationClass, Visibility visibility, CallConfiguration callConfig, String variableName, String name) {
    ...
    protected VariableAccessor verifyAccessorForRead(RubyClass cls) {
    ...
    protected VariableAccessor verifyAccessorForWrite(RubyClass cls) {
        VariableAccessor localAccessor = accessor;
        if (localAccessor.getClassId() != cls.id) {
